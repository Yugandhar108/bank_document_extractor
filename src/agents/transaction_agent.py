"""Transaction table extraction agent."""
...
from src.models.schemas import TransactionTable


PROMPT_FILE = PROJECT_ROOT / "prompts" / "transaction_table.json"
...
def extract_transaction_table(
...
) -> tuple[TransactionTable, str]:
    """Extract the transaction array from statement text."""
    ...
    validated = TransactionTable.model_validate(parsed)
